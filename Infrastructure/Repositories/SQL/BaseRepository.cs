...
namespace Infrastructure.Repositories.SQL
{
    public abstract class BaseRepository<T> : IBaseRepository<T>
    {
        ...
        {
            var parameters = SqlParameterNormalizer.Normalize(SqlHelper.Single(PrimaryKeyParamName, id));
        ...
        {
            var parameters = SqlParameterNormalizer.Normalize(BuildInsertParams(entity));
        ...
        {
            var parameters = SqlParameterNormalizer.Normalize(BuildUpdateParams(entity));
        ...
        {
            var parameters = SqlParameterNormalizer.Normalize(SqlHelper.Single("@Id", id));
            await _databaseHelper.ExecuteSqlCommandAsync(
                _connectionString,
                $"{TableName}_Delete",
                parameters,
