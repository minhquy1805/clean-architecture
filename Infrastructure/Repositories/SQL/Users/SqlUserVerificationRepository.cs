...
{
    public class SqlUserVerificationRepository : BaseRepository<UserVerification>, IUserVerificationRepository
    {
        public SqlUserVerificationRepository(IDatabaseHelper dbHelper, string connectionString)
